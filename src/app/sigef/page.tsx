        ...
        <form onSubmit={handleSearch} className="space-y-4">
          ...
          <div className="flex gap-3">
            <input
              ...
              className="flex-1 border border-gray-300 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#1351B4] focus:border-transparent"
            />
            <button
              type="submit"
              disabled={loading || !query.trim()}
              className="flex items-center gap-2 bg-[#1351B4] text-white px-6 py-2.5 rounded-lg hover:bg-[#071D41] transition-colors text-sm font-medium disabled:opacity-50"
            >
      ...
      {parcela && (
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-200 bg-gray-50">
            <h2 className="font-semibold text-[#071D41]">Dados da Parcela</h2>
          </div>
          <div className="p-6">
      ...
      {parcelas.length > 0 && (
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-200 bg-gray-50 flex items-center justify-between">
            <h2 className="font-semibold text-[#071D41]">Parcelas Encontradas</h2>
              ...
              <tbody className="divide-y divide-gray-100">
                {parcelas.map((p, i) => (
                  <tr key={i} className="hover:bg-gray-50">
                    <td className="px-4 py-3 text-sm font-mono text-[#1351B4]">{p.codigoParcela}</td>
