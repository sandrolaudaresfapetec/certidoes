...
description: Test RBAC filtering, authentication, and UI theme for the IGC SP certification system. Use when verifying role-based access control, process visibility, navigation filtering, or visual/branding changes.
---
